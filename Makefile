...
ACLOCAL = ${SHELL} /opt/Linux-PAM-1.1.1/missing --run aclocal-1.11
AMTAR = ${SHELL} /opt/Linux-PAM-1.1.1/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /opt/Linux-PAM-1.1.1/missing --run autoconf
AUTOHEADER = ${SHELL} /opt/Linux-PAM-1.1.1/missing --run autoheader
AUTOMAKE = ${SHELL} /opt/Linux-PAM-1.1.1/missing --run automake-1.11
AWK = gawk
BROWSER = 
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2 -W -Wall -Wbad-function-cast -Wcast-align -Wcast-qual -Wmissing-declarations -Wmissing-prototypes -Wpointer-arith -Wreturn-type -Wstrict-prototypes -Wwrite-strings -Winline -Wshadow
CPP = gcc -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
...
LTLIBINTL = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /opt/Linux-PAM-1.1.1/missing --run makeinfo
...
YACC = yacc
YFLAGS = 
abs_builddir = /opt/Linux-PAM-1.1.1
abs_srcdir = /opt/Linux-PAM-1.1.1
abs_top_builddir = /opt/Linux-PAM-1.1.1
abs_top_srcdir = /opt/Linux-PAM-1.1.1
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /opt/Linux-PAM-1.1.1/install-sh
libc_cv_fpie = yes
libdir = /lib64
